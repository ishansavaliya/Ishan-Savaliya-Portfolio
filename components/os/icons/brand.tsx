...
/**
 * Brand + UI icons. lucide-react dropped the GitHub/LinkedIn brand glyphs, so
 * we provide small SVG replacements and re-export the rest from lucide.
 */
export {
  Globe,
  ExternalLink,
...
export function Linkedin2({ size = 16, className }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
