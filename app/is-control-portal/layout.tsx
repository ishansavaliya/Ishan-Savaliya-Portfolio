...
const NAV = [
  ...
  { href: "/is-control-portal/comments", label: "Comments", icon: MessageCircle },
...
export default async function AdminLayout({
  ...
  return (
    <ThemeProvider>
      <div className="flex h-screen overflow-hidden bg-os-bg text-os-fg">
        <aside className="flex w-56 shrink-0 flex-col overflow-y-auto border-r border-white/10 p-4">
